...
///  HJBaseRequest is the base class you should inherit to create your own request class.
///  Based on HJCoreRequest, HJBaseRequest adds local caching feature. Note download
...
@interface HJBaseRequest : HJCoreRequest
