...
@class HJCoreRequest;
typedef void(^HJRequestCompletionBlock)(__kindof HJCoreRequest *request);


///  All the delegate methods will be called on the main queue.
@protocol HJRequestDelegate <NSObject>
@optional
- (void)requestFinished:(__kindof HJCoreRequest *)request;
- (void)requestFailed:(__kindof HJCoreRequest *)request;
@end
...
@interface HJCoreRequest : NSObject
...
///  Default is NO.
@property (nonatomic, assign) BOOL ignoreResumableData;
