...
@property (nonatomic, strong, readonly) NSArray<HJRequest *> *requestArray;
...
@property (nonatomic, strong, readonly, nullable) HJRequest *failedRequest;

@property (nonatomic, strong, readonly, nullable) NSArray<HJRequest *> *failedRequestArray;
