...
/**
 `HJDownloadOperation` is a subclass of `AFHTTPRequestOperation` for streamed file downloading. Supports Content-Range.
 */
@interface HJDownloadOperation : AFHTTPRequestOperation
...
/**
 Creates and returns an `HJDownloadOperation`
