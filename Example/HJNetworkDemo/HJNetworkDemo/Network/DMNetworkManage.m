...
- (NSString *)urlStringWithOriginUrlString:(NSString *)originUrlString
    ...
    if (DMNSStringAvailable(baseUrl) && DMNSDictionaryAvailable(args)) {
        return [NSString stringWithFormat:@"%@?%@", baseUrl, urlEncode?AFQueryStringFromParameters(args):DMQueryStringFromParameters(args)];
    } else if (DMNSStringAvailable(queryString) || (DMNSStringAvailable(originUrlString) && DMNSDictionaryAvailable(args))) {
        return [NSString stringWithFormat:@"?%@", urlEncode?AFQueryStringFromParameters(args):DMQueryStringFromParameters(args)];
    }
